...
async def force_sub(c, m):
    if Config.FORCE_SUB:
        try:
            ...
            logger.error(e)
            return await m.reply_text("Something went wrong. Try again and if same issue occurs contact [Support](https://t.me/fhhelperbor)", disable_web_page_preview=True, quote=True)
